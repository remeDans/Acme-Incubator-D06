...
<acme:form>
	...
	<acme:form-panel code="authenticated.investor.form.label.profile">
	<acme:form-url code="authenticated.investor.form.label.profile.photo" path="profile.photo"/>
	<acme:form-textarea code="authenticated.investor.form.label.profile.biography" path="profile.biography"/>
	</acme:form-panel>
