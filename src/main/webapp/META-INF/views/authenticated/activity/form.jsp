...
<acme:form readonly="true">
	...
	<acme:form-moment code="authenticated.activity.form.label.startMoment" path="startMoment"/>
	<acme:form-moment code="authenticated.activity.form.label.endMoment" path="endMoment"/>
