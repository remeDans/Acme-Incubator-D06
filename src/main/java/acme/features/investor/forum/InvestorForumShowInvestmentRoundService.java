...
import acme.features.investor.message.InvestorMessageRepository;
import acme.framework.components.Model;
import acme.framework.components.Request;
import acme.framework.services.AbstractShowService;

@Service
public class InvestorForumShowInvestmentRoundService implements AbstractShowService<Investor, Forum> {
	...
	@Autowired
	InvestorMessageRepository	messageRepository;
